export default function PageLinksLoad({ children, pageLinksList, display }) {
  return (
    <>
      ...
      <div
        className={`${display} gap-x-14 gap-y-10 xl:gap-x-12 mx-24 md:mx-44 lg:mx-48`}
      >
        {pageLinksList.map((pageLink, index) => (
          ...
          >
            <img
              ...
              className="max-h-60 w-full rounded-t-lg border border-black bg-gray-200 object-cover xl:aspect-[7/8] mb-0"
            />
