  ...
  return (
    <>
      <div className="w-window flex flex-col justify-center text-center mb-10">
        ...
        <PageText>
          Becoming a partner with The Humankind Charity means joining a movement
          dedicated to making a real difference in the lives of those who need
          it most. Becoming a partner play a vital role in supporting our
          mission, whether through sponsorships, collaborations, or ongoing
          commitments to humanitarian aid. We believe in building strong,
          meaningful relationships with those who stand with us, and we honour
          our partners by recognising their generosity, sharing their impact,
          ...
          today to explore how we can work together to help with humankind.
        </PageText>
        <div>
          <button
        ...
        <div
          className={
            showEmail
              ? `text-black bold mt-5`
              : `text-black bold mt-5 invisible`
          }
        >
