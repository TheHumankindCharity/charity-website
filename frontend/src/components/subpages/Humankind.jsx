...
export default function Humankind() {
  const imgUrl = "banners/humankind.jpg";
  return (
    <>
      <div className="w-window flex flex-col justify-center text-center mb-10">
        ...
        <PageText>
          ...
          Humankind Campaign is a powerful reminder that compassion and
          generosity can restore hope and provide life-saving relief. As we
          witness the devastating effects of poverty, conflict, and natural
          disasters, we are reminded that no one should ever have to face such
          hardship alone. Humankind Campaign is dedicated to addressing the most
          urgent needs of communities in distress, providing essential food,
          clean water, and hygiene supplies to vulnerable families across Syria,
          Yemen, Sudan, Palestine, Lebanon, Kenya, and Jordan. Through this
          initiative, we strive to bring immediate relief to those who are most
          in need, offering a lifeline that helps them survive and begin to
          rebuild their lives.
          <br />
          <br />
          ...
          hunger and suffering of individuals, we empower them to regain
          strength and focus on rebuilding their futures, one small step at a
          time.
          <br />
          <br />
          ...
          clean water solutions and sanitation facilities, reducing the spread
          of waterborne diseases and improving the overall health of communities
          in need. Clean water is not just a resource; it is a symbol of
          survival and dignity, and our goal is to bring this essential service
          to as many families as possible, ensuring they no longer have to worry
          about the life-threatening consequences of contaminated water.
          <br />
          <br />
          ...
          caught in the darkest moments of their lives. Whether through
          financial donations, volunteering, or spreading awareness, every small
          contribution helps us provide hope to those who need it most. The
          people we serve are not strangers, they are our brothers, sisters,
          mothers, fathers, and children. When you give to The Humankind
          Campaign, you are not just helping people in crisis, you are
          reaffirming the power of kindness, community, and the shared humanity
          that unites us all.
        </PageText>
