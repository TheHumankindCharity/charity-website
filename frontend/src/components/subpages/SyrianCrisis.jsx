    ...
    <>
      <div className="w-window flex flex-col justify-center text-center mb-10">
        ...
        <PageText>
          ...
          enough food to survive. Families have no homes, children and babies
          are going to sleep hungry, and millions are facing a daily fight for
          survival without food, water, or any of life's basic necessities. But
          in the face of this suffering you have the power to bring hope. By
          standing with Humankind you are not just offering aid you are offering
        ...
        <PageText>
          ...
          focused on addressing these critical needs by delivering essential
          food packages containing rice, flour, canned goods, and cooking oil to
        ...
        <PageText>
          ...
          dedicated to empowering the women of Syria, who have endured
          tremendous hardship and struggle daily to care for their children and
          families. We focus on providing essential resources that address the
          unique needs of women, such as sanitary pads, diapers, baby formula,
          and hygiene products. These basic but vital supplies are crucial in
          helping women maintain their health, dignity, and wellbeing. For
          mothers, these resources are not just practical, they are a lifeline
          ...
          their children. By joining the{" "}
          <span className="font-semibold">Womenkind</span> Campaign, we
          contribute to building stronger, healthier families in Syria and offer
          the hope of a brighter, more secure future for mothers and their loved
          ones.
        </PageText>
        <div>
          <button className="rounded p-2 mx-20 text-lg font-semibold text-white bg-[--maroon] border-2 border-[--maroon] hover:bg-red-700 hover:text-white active:bg-red-600">
